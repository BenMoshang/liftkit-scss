...
<div class="card card--heading"> <h3 class="heading">Card Title</h3>
  <p class="body">This card's padding is scaled based on the 'heading' text size.</p>
...
<section class="section__md">
  <div class="container__md">
    <div class="grid grid--lg col__3"> <div class="card"> <p class="body">Item 1</p>
        <span class="state"></span>
      </div>
      <div class="card">
